...
export default function Home () {
  ...
  return (
    <>
    <box>
      <h1 className="hometitle" >Toastmaster's Evaluator Assistant</h1>
      ...
      {/* <p className = "toastorg" >Toastmaster's International is a nonprofit educational organization that teaches public speaking and leadership skills through a worldwide network of clubs.</p> */}
